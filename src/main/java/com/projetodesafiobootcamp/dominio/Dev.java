...
public class Dev {
    ...
    private String nome;
    private Set<Conteudo> conteudosInscritos = new LinkedHashSet<>(); //Os cursos serão colocados na ordem de inserção
    private Set<Conteudo> conteudosConcluidos = new LinkedHashSet<>(); //As atividades serão colocadas na ordem de inserção
